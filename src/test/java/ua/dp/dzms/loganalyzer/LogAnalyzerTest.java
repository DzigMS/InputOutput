...
public class LogAnalyzerTest {
    ...
    public void parseFile(){
        ...
        ArrayList list = (ArrayList) logAnalyzer.parseFile("src/main/resources/access_log/access_logTest", timeFrom, timeTo);
        ...
        list = (ArrayList) logAnalyzer.parseFile("src/main/resources/access_log/access_logTest", timeFrom, timeTo);
